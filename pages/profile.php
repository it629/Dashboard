														...
														<div class="modal-body">
															<form class="comment-form">
																<div class="row"> 
																	<div class="col-lg-6">
																		<div class="mb-3">
																			<label class="form-label form-label">Name <span class="required">*</span></label>
																			<input type="text" class="form-control" value="Author" name="Author" placeholder="Author">
																		</div>
																	</div>
																	<div class="col-lg-6">
																		<div class="mb-3">
																			<label class="form-label form-label">Email <span class="required">*</span></label>
																			<input type="text" class="form-control" value="Email" placeholder="Email" name="Email">
																		</div>
																	</div>
																	<div class="col-lg-12">
																		<div class="mb-3">
																			<label class="form-label form-label">Comment</label>
								...
								<div class="card">
									<div class="card-body">
										<div class="profile-blog">
											<h4 class=" card-title text-primary d-inline">Today Highlights</h4>
											<img src="images/profile/1.jpg" alt="" class="img-fluid mt-4 mb-4 rounded w-100">
											<h4><a href="post-details.html">Darwin Creative Agency Theme</a></h4>
								...
								<div class="card">
									<div class="card-body">
										<div class="profile-interest">
											<h4 class="text-primary card-title d-inline">Interest</h4>
								...
								<div class="card">
									<div class="card-body">
										<div class="profile-news">
											<h4 class="text-primary card-title d-inline">Our Latest News</h4>
											<div class="media pt-3 pb-3">
												<img src="images/profile/5.jpg" alt="image" class="me-3 rounded" width="75">
												<div class="media-body">
													<h5><a href="post-details.html" class="text-dark">Transform Yourself, Conquer Limits.</a></h5>
											...
											<div class="media pt-3 pb-3">
												...
												<div class="media-body">
													<h5><a href="post-details.html" class="text-dark">Medical advancements globally.</a></h5>
													<p class="mb-0 line-para-height fs-15">I shared this on my fb wall a few months back, and I thought.</p>
												</div>
											</div>
											<div class="media pt-3 pb-0">
												<img src="images/profile/7.jpg" alt="image" class="me-3 rounded" width="75">
												<div class="media-body">
													<h5><a href="post-details.html" class="text-dark">Collection of textile samples</a></h5>
                                            ...
                                            <div id="my-posts" class="tab-pane fade active show">
                                                <div class="my-post-content pt-3">
                                                    ...
                                                    <div class="profile-uoloaded-post border-bottom-1 pb-5">
														...
														<a class="post-title" href="post-details.html"><h3>"Embark on a Journey of Unparalleled Excellence, Where Innovation and Elegance Converge to Shape Tomorrow's World."</h3></a>
                                                    ...
                                                    <div class="profile-uoloaded-post border-bottom-1 pb-5">
														...
														<a class="post-title" href="post-details.html"><h3>Collection of textile samples lay spread</h3></a>
                                                        <p>A wonderful serenity has take possession of my entire soul like these sweet morning of spare which enjoy whole heart.A wonderful serenity has take possession of my entire soul like these sweet morning
                                                            of spare which enjoy whole heart.</p>
                                                        <button class="btn btn-primary me-2"><span class="me-2"><i
                                                                    class="fa fa-heart"></i></span>Like</button>
                                                    ...
                                                    <div class="profile-uoloaded-post pb-3">
                                                        <img src="images/profile/10.jpg" alt="" class="img-fluid w-100 rounded">
														<a class="post-title" href="post-details.html"><h3>"Breakthrough Study Reveals Promising New Treatment Strategy for Alzheimer's Disease</h3></a>
                                                        <p>A wonderful serenity has take possession of my entire soul like these sweet morning of spare which enjoy whole heart.A wonderful serenity has take possession of my entire soul like these sweet morning
                                                            of spare which enjoy whole heart.</p>
                                                        <button class="btn btn-primary me-2"><span class="me-2"><i
                                                                    class="fa fa-heart"></i></span>Like</button>
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="mb-3 col-md-6">
																	...
																	<div class="input-group pass-group">
																		<input type="password" placeholder="Password" class="form-control pass-input">
